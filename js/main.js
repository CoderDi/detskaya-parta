...
$(document).ready(function(){
  ...
  $(".set-rating__star").click(function(){
    $(this).parents(".set-rating").addClass("active").find(".set-rating__star").removeClass("active");
  ...
  $(".js-checkout-next").click(function(){
    ...
    if ($(this).data("next") == "2") {
      $(".checkout-steps").css("left", "-280px");
    } else {
      if ($(this).data("next") == "3") {
        $(".checkout-steps").css("left", "-505px");
      }
    }
  });
  ...
  $(".single-tab__read-more").click(function(){
    $(this).prev(".single-tab__container").slideToggle(200);
    $(this).toggleClass("active");
  });

  function restructureReviews() { 
    if (($(".section.reviews").length)||($(".reviews-page").length)) {
  ...
  $(".instruction-filter__item_title").click(function(){
    if (window.innerWidth <= 768) {
      $(this).parents('.instruction-filter__item').toggleClass('active').find(".instruction-filter__item_list").slideToggle(200);
    }
  });
  $(".instruction-filter__item_btn").click(function(){
    if (window.innerWidth <= 768) {
      $(this).parents('.instruction-filter__item').removeClass('active').find(".instruction-filter__item_list").slideUp(200);
    }
  });
  $(".podbor__item_title").click(function(){
    if (window.innerWidth <= 768) {
      $(this).parents('.podbor__item').toggleClass('active').find(".podbor__item_list").slideToggle(200);
    }
  });
  $(".podbor__item_btn").click(function(){
    if (window.innerWidth <= 768) {
      $(this).parents('.podbor__item').removeClass('active').find(".podbor__item_list").slideUp(200);
    }
  });
  ...
  function windowsSlider() {    
    if (window.innerWidth <= 980) {
      ...
      if (($(".js-certs-slider").length != 0) && !($(".js-certs-slider").hasClass("slick-slider"))) {
  ...
  $(".js-structure-mobile").click(function(){
    $(this).toggleClass("line");
    $(".catalog-item").toggleClass("line");
  });
  ...
  $('.input--only-buk').on('keypress', function() {
    var that = this;
